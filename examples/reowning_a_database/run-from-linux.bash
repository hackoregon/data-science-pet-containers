...
docker cp reown_container_scripts containers_postgis_1:/home/dbsuper

echo "Running the script in the container"
echo ""
echo ""
docker exec -it -u dbsuper -w /home/dbsuper/reown_container_scripts containers_postgis_1 ./reown-demo.bash
