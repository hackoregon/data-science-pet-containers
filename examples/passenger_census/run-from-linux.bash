...
docker cp passenger_census_scripts containers_postgis_1:/home/dbsuper

echo "Running the script in the container"
echo ""
echo ""
docker exec -it -u dbsuper -w /home/dbsuper/passenger_census_scripts containers_postgis_1 ./make_database_backups.bash
