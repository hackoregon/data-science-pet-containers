...
* Linux Mint 18 / Ubuntu 16.06 LTS ("Xenial"): <https://github.com/hackoregon/data-science-pet-containers/blob/master/docs/Mint18-Xenial/README.md>
...
* On a server, there's a DBA and a SysAdmin that hands out privileges only with justification
